...
var chalk = require('chalk'),
  ...
  TaskMerger = require('./task-merger');
...
TaskManager.prototype.mergeTasks = function(day) {
  ...
  return taskManagerUtils.doWithDay(day, currentTask, function(data, deferred) {
    var taskMerger = new TaskMerger(data, deferred, taskManagerUtils.createFileName(day));
    taskMerger.run();
  });
};
